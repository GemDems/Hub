        ...
        <div className="text-center">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-2xl font-light text-gray-800 leading-relaxed tracking-wide mb-2">
              <span className="relative inline-block font-bold text-transparent bg-gradient-to-r from-emerald-600 to-green-500 bg-clip-text verified-glow-button overflow-hidden">
                Hand-picked deals
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-lg verified-glow-button overflow-hidden relative">
