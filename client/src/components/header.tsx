        ...
        <div className="text-center">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-2xl font-light text-gray-800 leading-relaxed tracking-wide mb-2">
              <span className="relative inline-block font-bold verified-glow-button hover:verified-glow-button">
                <span className="relative z-10 text-transparent bg-gradient-to-r from-emerald-600 to-green-500 bg-clip-text">Hand-picked deals</span>
                <span className="absolute -bottom-0.5 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-green-500 opacity-90 z-20 rounded-full"></span>
              </span>
              <span className="mx-3 font-normal">crafted by industry insiders</span>
            </p>
            <div className="flex flex-wrap items-center justify-center gap-6 text-lg verified-glow-button hover:verified-glow-button">
              <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-orange-50 to-red-50 rounded-full border border-orange-200 relative z-10">
                <div className="w-2 h-2 bg-orange-500 rounded-full animate-pulse"></div>
                <span className="font-semibold text-orange-700">Limited stock</span>
              </div>
              <div className="w-1 h-1 bg-gray-400 rounded-full relative z-10"></div>
              <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-red-50 to-pink-50 rounded-full border border-red-200 relative z-10">
