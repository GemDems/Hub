        ...
        <div className="text-center">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-2xl font-light text-gray-800 leading-relaxed tracking-wide mb-2">
              <span className="relative inline-block font-bold text-transparent bg-gradient-to-r from-emerald-600 to-green-500 bg-clip-text hover-flash-container">
                Hand-picked deals
                <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-emerald-300 to-green-300 opacity-60"></span>
                <span className="absolute -right-4 top-0 h-full w-1 bg-white opacity-70 animate-pulse shadow-white shadow-md"></span>
                <span className="absolute -right-4 top-0 h-full w-0.5 bg-white animated-flash-line"></span>
                <span className="absolute -right-2 top-0 h-full w-0.5 bg-white hover-sweep-line opacity-0"></span>
              </span>
